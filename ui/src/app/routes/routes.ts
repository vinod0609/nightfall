...
export const appRoutes: Routes = [
  ...
  { path: 'mintNFTCommitment', component: MintTokensComponent , canActivate: [AuthService]},
  ...
  { path: 'burnNFTCommitment', component: BurnTokenComponent , canActivate: [AuthService]},
  ...
  { path: 'mintFTCommitment' , component: MintCoinsComponent, canActivate: [AuthService] },
  { path: 'transferNFTCommitment', component: SpendTokenComponent, canActivate: [AuthService] },
  { path: 'transferFTCommitment', component: SpendCoinComponent, canActivate: [AuthService] },
  { path: 'burnFTCommitment', component: BurnCoinComponent, canActivate: [AuthService] },
